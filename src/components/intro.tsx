...
export default function Intro() {
    ...
    return (
        ...
        <section id="home"
            ...
            <motion.h1 className='mb-10 mt-4 px-4 text-xl font-medium !leading-[1.5] sm:text-4xl outline-none cursor-default'
                      initial={{opacity: 0, y: 100}}
                      animate={{opacity: 1, y: 0}}
            >

                <span className='font-bold'>Hello, I&apos;m Ilias Pavlakos</span>.
                I&apos;m a <span className='font-bold'>software engineer</span> passionate about crafting intricate
            ...
            <motion.div className='flex flex-col sm:flex-row items-center justify-center gap-4 text-lg font-medium px-4'
                        initial={{opacity: 0, y: 100}}
                        animate={{opacity: 1, y: 0}}
            ...
            >
                ...
                <a href='/cv_ilias_pavlakos.pdf' download={true}
                   ...
                   shadow hover:shadow-md outline-none cursor-pointer
                   focus:scale-[1.15] hover:scale-110 hover:bg-gray-950 active:scale-105
                   transition'
                >
                    Download CV
                    <HiDownload className="opacity-90 group-hover:text-green-400 group-active:text-green-400 transition" />
                </a>

                <Link className='group bg-white px-7 py-3 rounded-full
