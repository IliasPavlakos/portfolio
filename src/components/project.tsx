    ...
    return (
        <motion.div ref={ref}
            ...
            <section className='bg-gray-100 max-w-[42rem]
                                rounded-xl border border-black/5 shadow-md
                                overflow-hidden sm:pr-8 sm:h-[20rem] group-even:pl-8
                                relative
                                hover:bg-gray-200
                                hover:shadow-lg
                                transition'>

                <div className="pt-4 pb-7 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%]
                ...
                <Image src={imageUrl} alt="Project i worked on" quality={95}
                       className="absolute top-8 -right-40 w-[28.25rem] rounded-t-lg shadow-xl
                                  ...
                                  transisiton
                                  group-odd:group-hover:-translate-x-3 group-even:group-hover:translate-x-3
                                  group-odd:group-hover:-rotate-2 group-even:group-hover:rotate-2
